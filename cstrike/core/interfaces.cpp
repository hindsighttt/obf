...
#pragma region interface_game_exported
	...
	RessourceManager = Capture<IRessourceManager>(pResourceSystemRegisterList, RESOURCE_SYSTEM);
	bSuccess &= (ResourceSystem != nullptr);
...
#pragma endregion
	...
	SwapChain = **reinterpret_cast<ISwapChainDx11***>(MEM::GetAbsoluteAddress(MEM::FindPattern(RENDERSYSTEM_DLL, CS_XOR("48 89 2D EE 1C 46 00 48 C7 05 EB 1C 46 00 FF FF FF FF")), 0x3, 0x0));
	bSuccess &= (SwapChain != nullptr && SwapChain->pDXGISwapChain != nullptr);
	...
	GameTraceManager = *reinterpret_cast<CGameTraceManager**>(MEM::FindPattern(CLIENT_DLL, CS_XOR("48 8B 0D ? ? ? ? 48 8D 55 ? 66 89 44 24")));
